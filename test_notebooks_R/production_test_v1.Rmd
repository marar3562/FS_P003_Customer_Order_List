...
column_print_comb_openo = optimize_columns(df_long_del, 47)
...
workbook_created = function(data, width) {
...
wb_excel = workbook_created(df_long_symbol_excel, 39)
wb_openo = workbook_created(df_long_symbol_openo, 39)
