...
```{r}
file_name = 'Member Pick-up Details-04_06_2022.csv'
...
df_symbol_inputs_other = data.frame(match_name = c('contains', 'contains', 'contains','contains','contains','contains')
                             ,text_name = c('FF Dish - Creole Shrimp & Okra','Pork - Andouille links','Raw Milk Aged Cheddar','Pickup Time','Schlafly Beer','Pot Plant')
...
saveWorkbook(wb, "print_04_06_2022.xlsx", overwrite = TRUE)
```
