...
```{r}
file_name = 'Member Pick-up Details-04_14_2022.csv'
...
# group_h_stndrd = 'Deem, Jessica [37]'
# group_c_stndrd = 'Piepgrass, Erin [78]'
# group_m_stndrd = 'Biundo (staff), Rebecca [87]'
# group_u_stndrd = 'Brenner, Martin, Gretchen, Lisa [131]'
# 
# #Wednesday
# group_a_keep = TRUE
# group_h_keep = TRUE
...
#Thursday
group_a_stndrd = 'Garrett, Elizabeth/Kelly [35]'
group_h_stndrd = 'Lai, Austin [70]'
group_c_stndrd = 'Kruszynski, Stacy [10]'
group_m_stndrd = 'Craven, Star [89]'
group_u_stndrd = NA
...
saveWorkbook(wb_p, "PotPlant_File_2022_04_14.xlsx", overwrite = TRUE)
...
saveWorkbook(wb, "print_04_14_2022.xlsx", overwrite = TRUE)
```
