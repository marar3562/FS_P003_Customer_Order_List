...
# #Wednesday
# group_a_stndrd = 'Schwind, Anna [24]'     #Foster, Bill
# group_h_stndrd = 'Block, Chantal [35]'    #Sabo, Stephanie
# group_c_stndrd = NA
# group_m_stndrd = 'Crooks, Carol [91]'     #Biundo (staff), Rebecca
# group_u_stndrd = 'Dukes, Brian [133]'       #Karch/Slocum, Eric and Lee
# 
# #Wednesday
# group_a_keep = TRUE
# group_h_keep = TRUE
...
group_h_stndrd = 'Rothgangel, Ella [62]'            #'Kinman, Tricia [61]'
group_c_stndrd = NA                               #'Kruszynski, Stacy [10]'
group_m_stndrd = 'Karr, Mary [79]'
group_u_stndrd = 'Arbanas, Michael [101]'
...
# group_h_stndrd = NA
# group_c_stndrd = NA
# group_m_stndrd = 'Sanftner, Tracy [4]'  #Przyzycki, Lori
# group_u_stndrd = NA
# 
# #Friday
# group_a_keep = NA
