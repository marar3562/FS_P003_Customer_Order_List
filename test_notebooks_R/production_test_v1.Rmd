...
setColWidths(wb, "testing", cols = 1:2, widths = 39)
...
saveWorkbook(wb, paste0('print_',date,'.xlsx'), overwrite = TRUE)
...
# library(googledrive)
# drive_auth(email = '')
# (test_ss <- drive_upload(paste0(getwd(),'/','print_',date,'.xlsx'), type = "spreadsheet"))
# drive_browse(test_ss)
```
